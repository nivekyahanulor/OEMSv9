...
$query .= "SELECT *, (SELECT category FROM $CATEGORY_TABLE WHERE id = $PRODUCT_TABLE.category_id) AS category FROM $PRODUCT_TABLE WHERE ";
...
foreach($result as $row)
{
	...
	$sub_array[] = "₱".number_format(floatval($row["price"]), 2, '.', ',');
