...
$query .= "SELECT * FROM $RESERVATION_TABLE WHERE status = 'Declined' AND ";
...
foreach($result as $row)
{
	...
	$sub_array[] = $row['reservation_id']."<br><b>Reason:</b> ".$row['reason'];
...
{
	$statement = $connect->prepare("SELECT * FROM $TABLE WHERE status = 'Declined' ");
	$statement->execute();
